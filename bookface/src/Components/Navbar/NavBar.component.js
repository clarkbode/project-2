      ...
      return(
         ...
         <div className="">
               <div className="navbar navbar-light bg-danger flex-row-sb mt-1 mb-1">
                  ...
                  <div> 
                     <img Style="border-radius: 50%; width: 20%; height: 20%; align-items: right; border-style: solid; border-color: black;" src={drake} alt="Avatar" align="right" >
               ...
               <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <form className="form-inline my-2 my-lg-0 ">
                     ...
                     <button className="btn btn-danger my-2 my-sm-0 mr-10" type="button">Search</button>
                  </form>
